...
const SearchPage = () => {
  ...
  return (
      <div className="search-container px-4 py-20 sm:py-32 bg-gray-900 min-h-screen">
      <div className="max-w-4xl mx-auto text-center">
        ...
        <form onSubmit={handleSearch} className="flex flex-col items-center space-y-6">
          {/* Dropdowns */}
          <div className="flex flex-col sm:flex-row sm:space-x-6 w-full sm:justify-center space-y-4 sm:space-y-0 mb-2">
            <select
              value={searchType}
              onChange={(e) => setSearchType(e.target.value)}
              className="w-full sm:w-[200px] p-4 text-lg text-gray-700 bg-white border-2 border-[#2ac9ff] rounded-full focus:outline-none focus:ring-2 focus:ring-[#2ac9ff]"
            >
          ...
          <input
            ...
            className="w-full sm:w-[700px] p-4 text-lg text-gray-700 border-2 border-[#2ac9ff] rounded-full focus:outline-none focus:ring-2 focus:ring-[#2ac9ff]"
            required
          />
